"""Tests for La Poste diagnostics."""
from datetime import timedelta
from unittest.mock import MagicMock

from custom_components.laposte.diagnostics import (
...
async def test_diagnostics_reports_suspended_polling(hass):
    """update_interval None (the full-stop condition) must be visible, not just absent."""
    entry = MagicMock()
