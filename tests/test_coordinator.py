"""Tests for the La Poste coordinator: fetching, caching and events.
...
from custom_components.laposte.coordinator import LaPosteCoordinator
...
async def test_update_keeps_cached_payload_on_error(hass):
    ...
    client.async_get_parcel.side_effect = LaPosteApiError("HTTP 500")
