"""Constants for the La Poste parcel tracker integration."""
...
# The consumer edge accepts this signature over aiohttp HTTP/1.1, but returns
# 403 to aiohttp's normal identity and to the compact integration identity.
