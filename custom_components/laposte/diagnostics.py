"""Diagnostics support for the La Poste parcel tracker integration."""
...
TO_REDACT = {
    ...
    "merchantName",
    "partner",
    # Defensive legacy/common names: an unexpected payload shape must still
    # not leak a recipient or address in a public diagnostic.
    "trackingNumber",
    "recipient",
    "deliveryAddress",
    "address",
...
async def async_get_config_entry_diagnostics(
    ...
    """Return diagnostics for the La Poste config entry."""
